...
interface EnvironmentsVariables {
  ...
  KAFKA_TOPIC: string;
  NOTIFICATIONS_KAFKA_CLIENT_ID: string;
  NOTIFICATIONS_KAFKA_GROUP_ID: string;
...
const environmentsSchema = Joi.object<EnvironmentsVariables>({
  ...
  NOTIFICATIONS_KAFKA_CLIENT_ID: Joi.string().required(),
  NOTIFICATIONS_KAFKA_GROUP_ID: Joi.string().required(),
...
export const environments: EnvironmentsVariables = {
  ...
  NOTIFICATIONS_KAFKA_CLIENT_ID: envVars.NOTIFICATIONS_KAFKA_CLIENT_ID,
  NOTIFICATIONS_KAFKA_GROUP_ID: envVars.NOTIFICATIONS_KAFKA_GROUP_ID,
